...
function sailor_get_avatar_placeholder() {
    return get_template_directory_uri() . '/html/assets/img/default-avatar.svg';
}

function sailor_get_image_placeholder($w = 600, $h = 400, $text = 'Sailor') {
    return get_template_directory_uri() . '/html/assets/img/default-image.svg';
}
...
function sailor_theme_scripts() {
    ...
    $asset_uri = get_template_directory_uri() . '/html/assets';
    ...
    // Vendor CSS
    wp_enqueue_style('bootstrap',         $asset_uri . '/vendor/bootstrap/css/bootstrap.min.css', array(), '5.3.3');
    wp_enqueue_style('bootstrap-icons',   $asset_uri . '/vendor/bootstrap-icons/bootstrap-icons.css', array(), '1.11.3');
    wp_enqueue_style('aos',               $asset_uri . '/vendor/aos/aos.css', array(), '2.3.4');
    wp_enqueue_style('glightbox',         $asset_uri . '/vendor/glightbox/css/glightbox.min.css', array(), '3.3.0');
    wp_enqueue_style('swiper',            $asset_uri . '/vendor/swiper/swiper-bundle.min.css', array(), '11.0');

    // Theme CSS
    wp_enqueue_style('sailor-main',       $asset_uri . '/css/main.css', array('bootstrap', 'google-font-pt-sans'), $v);
    wp_enqueue_style('sailor-style',      get_stylesheet_uri(), array('sailor-main'), $v);


    // Vendor JS (footer)
    wp_enqueue_script('bootstrap-bundle', $asset_uri . '/vendor/bootstrap/js/bootstrap.bundle.min.js', array(), '5.3.3', true);
    wp_enqueue_script('aos',              $asset_uri . '/vendor/aos/aos.js', array(), '2.3.4', true);
    wp_enqueue_script('glightbox',        $asset_uri . '/vendor/glightbox/js/glightbox.min.js', array(), '3.3.0', true);
    wp_enqueue_script('imagesloaded',     $asset_uri . '/vendor/imagesloaded/imagesloaded.pkgd.min.js', array(), '5.0', true);
    wp_enqueue_script('isotope',          $asset_uri . '/vendor/isotope-layout/isotope.pkgd.min.js', array(), '3.0.6', true);
    wp_enqueue_script('purecounter',      $asset_uri . '/vendor/purecounter/purecounter_vanilla.js', array(), '1.5', true);
    wp_enqueue_script('waypoints',        $asset_uri . '/vendor/waypoints/noframework.waypoints.js', array(), '4.0', true);
    wp_enqueue_script('swiper',           $asset_uri . '/vendor/swiper/swiper-bundle.min.js', array(), '11.0', true);

    // Theme JS (last)
    wp_enqueue_script('sailor-main-js',   $asset_uri . '/js/main.js', array('bootstrap-bundle'), $v, true);
}
...
function sailor_admin_icon_picker_assets($hook) {
    ...
    wp_enqueue_style('bootstrap-icons-admin', get_template_directory_uri() . '/html/assets/vendor/bootstrap-icons/bootstrap-icons.css', array(), '1.11.3');
}
